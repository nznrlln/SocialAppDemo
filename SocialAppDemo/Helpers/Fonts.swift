...
struct Fonts {
    ...
    // attention texts font
    static let interMed12 = UIFont(name: "Inter-Medium", size: 12) ?? UIFont.systemFont(ofSize: 12)
    static let interMed14 = UIFont(name: "Inter-Medium", size: 14) ?? UIFont.systemFont(ofSize: 14)
    static let interMed16 = UIFont(name: "Inter-Medium", size: 16) ?? UIFont.systemFont(ofSize: 16)
